...
export function buildSpatialGrid(meshes) {
    spatialGrid.clear();
    // Xoá cache ô lưới cũ - tránh trường hợp queryNearbyMeshes() trả về mesh va chạm
    // của MAP TRƯỚC ĐÓ khi người chơi spawn vào đúng ô lưới có cùng key ở map mới.
    lastPlayerCellKey = null;
    cachedNearbyMeshes = [];
